    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        systemOverlayStyle: SystemUiOverlayStyle(
          ...
          // Si el fondo es oscuro -> iconos claros (light). Si es claro -> iconos oscuros (dark).
          statusBarIconBrightness: isDark ? Brightness.light : Brightness.dark,
          statusBarBrightness:
              isDark ? Brightness.dark : Brightness.light, // Para iOS
        ),
      ),
      body: SafeArea(
        child: Center(
